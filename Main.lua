...
local function GWXWN_fake_script() -- Top.Dragify 
...
coroutine.wrap(GWXWN_fake_script)()
local function VBZL_fake_script() -- Close.LocalScript 
...
coroutine.wrap(VBZL_fake_script)()
local function FYCWOZ_fake_script() -- HomeB.LocalScript 
...
coroutine.wrap(FYCWOZ_fake_script)()
local function SVGDISP_fake_script() -- GamesB.LocalScript 
...
coroutine.wrap(SVGDISP_fake_script)()
local function CWVXNY_fake_script() -- SettingsB.LocalScript 
...
coroutine.wrap(CWVXNY_fake_script)()
local function LRQCJ_fake_script() -- ProfileImage.LocalScript 
...
coroutine.wrap(LRQCJ_fake_script)()
local function XGAYVPC_fake_script() -- Home.LocalScript 
...
coroutine.wrap(XGAYVPC_fake_script)()
local function APQJ_fake_script() -- Exe.LocalScript 
...
coroutine.wrap(APQJ_fake_script)()
local function JQQOIO_fake_script() -- Scan.LocalScript 
...
coroutine.wrap(JQQOIO_fake_script)()
local function JQIFPAW_fake_script() -- Hs.LocalScript 
...
coroutine.wrap(JQIFPAW_fake_script)()
local function SFKKQ_fake_script() -- Clr.LocalScript 
...
coroutine.wrap(SFKKQ_fake_script)()
local function JFJYM_fake_script() -- Re.LocalScript 
...
coroutine.wrap(JFJYM_fake_script)()
